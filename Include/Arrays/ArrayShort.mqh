...
public:
   ...
   virtual int       Type() const        { return(TYPE_SHORT); }
   ...
   bool              Add(short element);
   bool              AddArray(const short &src[]);
   bool              AddArray(const CArrayShort *src);
   bool              Insert(short element,int pos);
   bool              InsertArray(const short &src[],int pos);
   bool              InsertArray(const CArrayShort *src,int pos);
   bool              AssignArray(const short &src[]);
   bool              AssignArray(const CArrayShort *src);
   //--- method of access to the array
   short             At(int index) const;
   //--- methods of changing
   bool              Update(int index,short element);
   ...
   bool              InsertSort(short element);
   int               Search(short element) const;
   int               SearchGreat(short element) const;
   int               SearchLess(short element) const;
   int               SearchGreatOrEqual(short element) const;
   int               SearchLessOrEqual(short element) const;
   int               SearchFirst(short element) const;
   int               SearchLast(short element) const;
   int               SearchLinear(short element) const;
protected:
   virtual void      QuickSort(int beg,int end,int mode=0);
   int               QuickSearch(short element) const;
   int               MemMove(int dest,int src,int count);
  };
//+------------------------------------------------------------------+
//| Constructor CArrayShort.                                         |
//| INPUT:  no.                                                      |
//| OUTPUT: no.                                                      |
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
void CArrayShort::CArrayShort()
  {
//--- initialize protected data
   m_data_max=ArraySize(m_data);
  }
//+------------------------------------------------------------------+
//| Destructor CArrayShort.                                          |
//| INPUT:  no.                                                      |
//| OUTPUT: no.                                                      |
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
int CArrayShort::MemMove(int dest,int src,int count)
  {
   int i;
//--- checking
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CArrayShort::Reserve(int size)
  {
   int new_size;
//--- checking
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CArrayShort::Resize(int size)
  {
   int new_size;
//--- checking
   if(size<0) return(false);
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CArrayShort::Add(short element)
  {
...
//+------------------------------------------------------------------+
//| Adding an element to the end of the array from another array.    |
//| INPUT:  src - pointer to an instance of class CArrayShort.       |
//| OUTPUT: true if successful, false if not.                        |
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CArrayShort::Insert(short element,int pos)
  {
//--- checking/reserving elements of array
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CArrayShort::InsertArray(const short &src[],int pos)
  {
   int num=ArraySize(src);
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CArrayShort::InsertArray(const CArrayShort *src,int pos)
  {
   int num;
//--- checking
   if(!CheckPointer(src)) return(false);
...
//| OUTPUT: value of element in the specified position or SHORT_MAX. |
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
short CArrayShort::At(int index) const
  {
//--- checking
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CArrayShort::Update(int index,short element)
  {
//--- checking
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CArrayShort::Shift(int index,int shift)
  {
   short tmp_short;
//--- checking
...
//+------------------------------------------------------------------+
bool CArrayShort::Delete(int index)
  {
//--- checking
   if(index<0 || index>=m_data_total) return(false);
//--- deleting
...
//+------------------------------------------------------------------+
//| Equality comparison of two arrays.                               |
//| INPUT:  array - pointer to an instance of class CArrayShort      |
//|         to be compared.                                          |
//| OUTPUT: true if arrays are equal, false if not.                  |
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
void CArrayShort::QuickSort(int beg,int end,int mode)
  {
   int   i,j;
...
//| REMARK: does not violate the sorting.                            |
//+------------------------------------------------------------------+
bool CArrayShort::InsertSort(short element)
  {
   int pos;
//--- checking
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
int CArrayShort::SearchLinear(short element) const
  {
//--- checking
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
int CArrayShort::QuickSearch(short element) const
  {
   int   i,j,m=-1;
   short t_short;
//--- search
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
int CArrayShort::Search(short element) const
  {
   int pos;
//--- checking
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
int CArrayShort::SearchGreat(short element) const
  {
   int pos;
//--- checking
   if(m_data_total==0 || !IsSorted()) return(-1);
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
int CArrayShort::SearchLess(short element) const
  {
   int pos;
//--- checking
   if(m_data_total==0 || !IsSorted()) return(-1);
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
int CArrayShort::SearchGreatOrEqual(short element) const
  {
   int pos;
//--- checking
   if(m_data_total==0 || !IsSorted()) return(-1);
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
int CArrayShort::SearchLessOrEqual(short element) const
  {
   int pos;
//--- checking
   if(m_data_total==0 || !IsSorted()) return(-1);
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
int CArrayShort::SearchFirst(short element) const
  {
   int pos;
//--- checking
   if(m_data_total==0 || !IsSorted()) return(-1);
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
int CArrayShort::SearchLast(short element) const
  {
   int pos;
//--- checking
   if(m_data_total==0 || !IsSorted()) return(-1);
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CArrayShort::Save(int file_handle)
  {
   int i=0;
//--- checking
...
//| REMARK: no.                                                      |
//+------------------------------------------------------------------+
bool CArrayShort::Load(int file_handle)
  {
   int i=0,num;
//--- checking
