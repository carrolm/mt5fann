...
//+------------------------------------------------------------------+
//| Объявим переменные для хранения состояния кнопок                 |
//+------------------------------------------------------------------+
int showMA=0;
int showMACD=0;
int showPC=0;
...
void OnDeinit(const int reason)
  {
//--- удаляем графические объекты созданные в процессе работы эксперта
...
//--- рисуем графические обекты на графике в верхнем левом углу
   int size=14;//((int)ChartGetInteger(0,CHART_HEIGHT_IN_PIXELS)/22);
   int i=0;
   int x=10;
   int y=0;
   int fz=size-4;
